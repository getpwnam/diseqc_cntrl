...
W5500OPEN_ADDR="$(resolve_addr 'Library_cubley_interop_W5500Socket_NativeOpen___STATIC__I4')"
W5500CLOSE_ADDR="$(resolve_addr 'Library_cubley_interop_W5500Socket_NativeClose___STATIC__I4__I4')"
