...
// USART3 (PD8/PD9) is reserved exclusively for the nanoFramework wire protocol.
// DebugTextPort is disabled so hal_printf output cannot interleave with wire
// protocol packets on COM3.
HAL_SYSTEM_CONFIG HalSystemConfig = {
    {true}, // HAL_DRIVER_CONFIG_HEADER Header

    ConvertCOM_DebugHandle(3), // DebuggerPort   -> COM3 (wire protocol)
    0,                         // DebugTextPort  -> disabled (no hal_printf on COM3)
