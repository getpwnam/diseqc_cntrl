...
#define LNB_NATIVE_POLARIZATION_HORIZONTAL (1u << 0)
#define LNB_NATIVE_POLARIZATION_VERTICAL (1u << 1)

#define LNB_NATIVE_BAND_HIGH (1u << 0)
#define LNB_NATIVE_BAND_LOW (1u << 1)
